        ...
        <div className="mb-24">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="grid gap-4"
                    ...
                    <div>
                        <img className="h-auto max-w-full rounded-lg" src="https://media.istockphoto.com/id/1179742089/photo/curious-boy-playing-with-newtons-cradle.jpg?s=612x612&w=0&k=20&c=xSZ9BMbf1TQECv3kKbcoYzDPQPrGmetpLUF94VQol9c=" alt="" />
                    </div>
                    <div>
                ...
                <div className="grid gap-4"
                    ...
                    <div>
                        <img className="h-auto max-w-full rounded-lg" src="https://media.istockphoto.com/id/1386855572/photo/top-view-colorful-eco-friendly-non-plastic-wooden-toys-on-white-table-early-learning-and.jpg?s=612x612&w=0&k=20&c=dSKIyG7gu9ByqNRAI0pq9JU-Z8xqWasLSYPRoqlJCfw=" alt="" />
                    </div>
                    <div>
                ...
                <div className="grid gap-4"
                    ...
                    <div>
                        <img className="h-auto max-w-full rounded-lg" src="https://media.istockphoto.com/id/1273835104/photo/wooden-toys-on-yellow-background-still-life.jpg?s=612x612&w=0&k=20&c=I1PbU0J--P78Idpdu7vuIeZ4OxAtRKftqxG6HrSYni0=" alt="" />
                    </div>
                    <div>
                ...
                <div className="grid gap-4"
                    ...
                    <div>
                        <img className="h-auto max-w-full rounded-lg" src="https://media.istockphoto.com/id/1357660141/photo/closeup-of-childs-hands-playing-with-alphabet-toy-block.jpg?s=612x612&w=0&k=20&c=il3NpemGDaBUoK4hEukD_xVhePVAXXcLdYFlg2-cqRo=" alt="" />
                    </div>
                    <div>
                        <img className="h-auto max-w-full rounded-lg" src="https://media.istockphoto.com/id/1127750319/photo/boy-making-robot-toy-for-school-project-with-his-sister.jpg?s=612x612&w=0&k=20&c=Vu0U2wBqIP0_X88VHgpGlPjIFtjQ_jU4vPeJcjI8GUQ=" alt="" />
                    </div>
                </div>
            </div>
        </div >
